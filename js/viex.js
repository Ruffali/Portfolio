...
$(function () {
    ...
    $(".open-menu-content").on("click", function () {
        $(this).toggleClass("opened")
        if ($(this).hasClass("opened")) {
            $(this).children().children().text("Back to home")
            setTimeout(function () { $("#up").addClass("d-block") }, 500);
        } else {
            $(this).children().children().text("more information")
            setTimeout(function () { $("#up").removeClass("d-block") }, 0);
        }
    })
    $(".close-menu-content").on("click", function () {
        $(".open-menu-content").removeClass("opened")
        $(".open-menu-content").children().children().text("more information")
        setTimeout(function () { $("#up").removeClass("d-block") }, 0);
    })
    ...
    $("#up").click(function () {
        panel.animate({ scrollTop: 0 }, 1000);
        return false;
    })
